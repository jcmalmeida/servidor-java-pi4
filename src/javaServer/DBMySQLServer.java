...
import javaServer.core.MeuPreparedStatement;
...
public class DBMySQLServer {
    ...
    static {
        ...
        try (FileInputStream fis = new FileInputStream("/Users/joaocarlosmartinsdealmeida/pi4/Servidor-Raiz/db.properties")) {
            props.load(fis);
        } catch (IOException e) {
